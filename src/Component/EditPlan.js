...
function EditPlan() {
    ...
    const changePlan = () => {
        ...
        localStorage.setItem('exercise-data',JSON.stringify(exercises))
        ...
        fetch(`https://6369938efdfc.ngrok.io/plans/${Data.id}`, {
            method: 'put',
            headers: {
                                ...
                                <div className="edit-card">
                                    <div className="edit-card-body">
                                        ...
                                        <div className="edit-card-content">
                                            <h6> Exericse-name &emsp; &emsp;   <span style={{ color: 'blue' }}> {exercise['ex_name']} </span></h6>
                                            <h6> Exercise-level &emsp; &emsp;&nbsp; &nbsp;<span style={{ color: 'blue' }}> {exercise['ex_type']} </span></h6>
                                        </div>
                                    </div>
