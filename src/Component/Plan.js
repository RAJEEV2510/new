...
function Plan() {
    ...
    useEffect(() => {
        ...
        fetch("https://6369938efdfc.ngrok.io/plans").then(res => res.json()).then((data) => {
                            ...
                            <div key={uuid()} className="plan">
                                ...
                                <div className="mydates" >
                                            <div className="start-Date">
                                             {value.startDate?  <><i class="fa fa-calendar" aria-hidden="true"></i>&emsp; Start Date &emsp; {value.startDate}</>:"" }
                                            </div>
                                            <div className="end-Date">
                                            {value.endDate?  <> <i class="fa fa-calendar" aria-hidden="true"></i>&emsp; End Date &emsp; {value.endDate} </>:"" }
