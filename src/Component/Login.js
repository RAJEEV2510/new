...
const handleSubmit=(e)=>{
    ...
    console.log(obj)
    fetch('http://befit.digitaldarwin.in/myphio-user-management/v1/user/login', {
        method: 'POST', 
        headers: {
      ...
      notify("now you are in dashboard");
...
return (
  ...
  <button type="submit" class="btn btn-primary">Submit</button>
        ...
        <div className="container  col-10 col-lg-4 col-sm-6 col-md-8">
                   ...
                   <form className="main-form text-center">
                       ...
                       <div className="form-group my-0">
                           <label className="my-0">
                               ...
                               <input type="text" className="myinput" placeholder="Username" onChange={(e)=>{
                                   setUsername(e.target.value)
                               }}></input>
                           </label>
                       </div>
                       ...
                       <div className="form-group">
                           <label className="my-0">
                               ...
                               <input type="button" className="form-control button" onClick={(e)=>{handleSubmit(e)}} value="Login">
